...
The most well-known tree-climbing goats are in Morocco, where they scale argan trees to eat the fruit and leaves. It's become a major tourist attraction, and photos of goats perched in the branches have spread all over the internet.

These goats have been climbing argan trees for centuries because the trees are one of the few food sources in that arid landscape. Their climbing skills helped them survive in an environment where ground-level forage is scarce.
...
If your goats are destroying fruit trees or ornamentals, you need a physical barrier. Wrap the lower trunk with hardware cloth or chicken wire up to about 4 feet to prevent them from getting a grip with their hooves.

Pruning lower branches removes the on-ramp that goats need to start their climb. Without that first low branch or fork in the trunk, most goats will give up and move on to something else.
