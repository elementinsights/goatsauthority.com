...
The key word here is moderation. Peppermint itself is not harmful to goats, but the sugar in peppermint candy is what you need to watch.
...
The easiest method is to drop one or two peppermint candies into a goat's feed bucket. They will find them quickly and crunch right through them.
...
Keep it simple: limit peppermint candy treats to a couple pieces per goat and do not offer them every day. Fresh peppermint leaves are always the safer option since there is no added sugar.
...
The two you should avoid are pennyroyal and wintergreen. Pennyroyal can be toxic in larger amounts, and wintergreen contains compounds that are harder on a goat's system. Stick with the common garden mints and you will be in good shape.
...
Peppermint is a safe treat for goats when you keep the portions small. Fresh peppermint leaves are the healthiest option, and a candy cane or two will not cause any harm either.
