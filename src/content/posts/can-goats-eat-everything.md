...
The "goats eat anything" myth comes from the way they use their mouths to explore the world. A goat will mouth a tin can, a shirt sleeve, or a cardboard box out of curiosity, but most of the time it spits the object right back out. What it is actually going for on that tin can is the glue holding the label, which contains trace minerals.
...
Goats do not eat everything. They are selective, curious browsers that use their mouths the way we use our hands, and that behavior gets mistaken for indiscriminate eating.
