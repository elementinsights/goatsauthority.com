...
Use only the original formula. Do not use Neosporin with pain relief because it contains pramoxine, which hasn't been tested on goats. Also skip the "Plus" version for the same reason.
