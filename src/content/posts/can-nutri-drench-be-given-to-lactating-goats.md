...
description: "Many people are curious if Nutri Drench can be given to lactating goats or not. And if so, what are the things you need to consider? we will answer those questions regarding giving Nutri Drench to lactating goats."
category: "health"
postType: "guide"
...
toc:
  ...
  - label: "What is Nutri-Drench and what's in it?"
    href: "#what-is-nutri-drench-and-whats-in-it"
  - label: "When to use Nutri-Drench for lactating does"
    href: "#when-to-use-nutri-drench-for-lactating-does"
