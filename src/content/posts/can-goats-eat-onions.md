...
toc:
  ...
  - label: "Why onions are dangerous for goats"
    href: "#why-onions-are-dangerous-for-goats"
  - label: "Symptoms of onion toxicity"
    href: "#symptoms-of-onion-toxicity"
  - label: "What about garlic and other alliums?"
    href: "#what-about-garlic-and-other-alliums"
  - label: "Keeping goats away from onions"
    href: "#keeping-goats-away-from-onions"
...
A single nibble probably will not hurt them, but that does not mean onions belong in their diet. Here is why you should keep your goats away from the onion patch.

## Can goats eat onions?

Onions are not recommended for goats. While a goat that grabs a bite of onion from the garden is not going to drop dead on the spot, onions contain compounds that are genuinely harmful to goats over time.

The risk is not from one small taste. The problem comes when goats eat onions regularly or consume a large amount at once. This is one of those foods where "they can eat it" and "they should eat it" are two very different things.
...
This damage is cumulative. A goat that eats a small amount of onion every day for a week can develop anemia just as easily as one that eats a large amount in one sitting. The red blood cells break down faster than the body can replace them.
...
The first sign you will notice is pale or yellowish gums. Pull back your goat's lip and check the color of the gum tissue above the teeth. Healthy gums should be bright pink, so anything lighter is cause for concern.
...
Lethargy and rapid breathing usually follow within one to four days after the goat eats a significant amount of onion. The goat's body is not getting enough oxygen because its red blood cell count has dropped. If you see these signs, call your vet immediately.
